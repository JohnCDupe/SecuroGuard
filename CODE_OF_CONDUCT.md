...
- Sharing live malware, exploits, credentials, or private files in public spaces of
  the project
...
Abusive, harassing, or otherwise unacceptable behavior that occurs in this project's
GitHub spaces (issues, pull requests, discussions, and comments) can be reported to
GitHub directly using their built-in content- and abuse-reporting tools, available
from the menu on the offending content — see GitHub's documentation on
[reporting abuse or spam](https://docs.github.com/en/communities/maintaining-your-safety-on-github/reporting-abuse-or-spam).

A dedicated project channel for reporting conduct concerns privately to the
maintainers is not yet established. Please do **not** use the security vulnerability
reporting channel for conduct complaints — that channel is reserved for security
issues only.
